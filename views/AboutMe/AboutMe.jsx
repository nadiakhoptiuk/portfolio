    ...
    <Section id={blockAnchorId} className="!pt-0">
      <div className="md:flex md:flex-row-reverse xl:justify-end">
        <div className="pt-6 md:ml-8 xl:pt-[36px]">
          ...
          <div className="markdown-wrapper mb-10 text-small font-light text-black prose-p:mb-4 md:mb-9 xl:mb-16 xl:w-[582px] xl:text-[20px] xl:leading-[28px] xl:prose-p:mb-9 xl:prose-p:font-normal">
        ...
        <div className="flex-shrink-0 overflow-hidden rounded md:h-[420px] md:w-[336px] xl:h-[538px] xl:w-[479px] smOnly:mb-10">
          <Image
